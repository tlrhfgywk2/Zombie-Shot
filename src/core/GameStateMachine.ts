export type GamePhase = 'AMMO_SELECTION' | 'LOADING' | 'FIRING' | 'ENEMY_ACTION' | 'AMMO_REWARD' | 'ROUTE_SELECTION' | 'GAME_OVER' | 'VICTORY';
...
const ALLOWED_TRANSITIONS: Record<GamePhase, readonly GamePhase[]> = {
  ...
  ENEMY_ACTION: ['AMMO_SELECTION', 'AMMO_REWARD', 'GAME_OVER'],
