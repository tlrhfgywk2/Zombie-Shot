...
export const ENEMY_DEFINITIONS: Record<EnemyType, EnemyDefinition> = {
  ...
  fast: { id: 'fast', name: '질주 감염체', role: '충격과 냉기로 제어할 근접 압박 표적', hp: 86, armor: 0, distance: 5, advancePerTurn: 3.1, staggerThreshold: 85, special: false },
  ...
  contaminator: { id: 'contaminator', name: '오염 투척체', role: '장착물 슬롯을 봉쇄', hp: 215, armor: 18, distance: 6, advancePerTurn: 2.8, staggerThreshold: 130, special: true, intent: { type: 'contaminate', name: '오염 투척', description: '다음 행동: 장착물 슬롯 하나를 2턴 봉쇄', initialCountdown: 1, cooldown: 3 } },
  groundshaker: { id: 'groundshaker', name: '지반 파쇄체', role: '정확도 중심 빌드를 흔듦', hp: 210, armor: 28, distance: 6.5, advancePerTurn: 2.8, staggerThreshold: 145, special: true, intent: { type: 'groundShock', name: '지반 충격', description: '다음 행동: 정확도 -22% (2턴)', initialCountdown: 1, cooldown: 3 } },
  screecher: { id: 'screecher', name: '공명 비명체', role: '원거리 효율을 압박', hp: 195, armor: 12, distance: 7, advancePerTurn: 3, staggerThreshold: 120, special: true, intent: { type: 'sonicPulse', name: '초음파 공명', description: '다음 행동: 유효 거리 1단계 감소 (2턴)', initialCountdown: 1, cooldown: 3 } },
};
